...
khoan_chi = c("Quốc phòng", "An ninh xã hội", "Y tế","Trả lãi nợ quốc gia", "Các chương trình xã hội khác", "Các chi phí khác")
pie(ti_le, labels = khoan_chi, col = rainbow(6), main = "Biểu đồ các khoản chi tiêu", sub = "Số liệu năm 2006")
...
matrix
barplot(matrix, beside = TRUE, xlab = "Năm", ylab = "Số lượng xe" ,col = c("cyan", "pink"), main = "Sự thay đổi về việc lựa chọn xe", sub = "Số liệu năm 2002", names.arg = c(1990, 1995, 1997, 1998, 1999, 2000, 2001, 2002), ylim = c(0, 12))
...
party_count
barplot(party_count, names.arg = c("Dân chủ", "Cộng hòa"), col = c("purple", "green"), main = "Số lượng thành viên giữa hai đảng", border = "black", ylab = "Số lượng thành viên", xlab = "Đảng")
mtext("Người", at = 0)
